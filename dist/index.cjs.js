...
var MenuSvg = styled__default['default'].svg(templateObject_4$c || (templateObject_4$c = __makeTemplateObject(["\n  align-self: center; // Safari fix\n  stroke: ", ";\n  flex-shrink: 0;\n  ", "\n  ", "\n"], ["\n  align-self: center; // Safari fix\n  stroke: ", ";\n  flex-shrink: 0;\n  ", "\n  ", "\n"])), function (_a) {
    var theme = _a.theme, color = _a.color;
    return getThemeValue("colors." + color, color)(theme);
}, function (_a) {
    var spin = _a.spin;
...
var Icon$1k = function (props) {
    return (React__default['default'].createElement(MenuSvg, __assign({ viewBox: "0 0 48 48" }, props),
        React__default['default'].createElement("style", null, ".st2{fill:none;stroke-width:2;stroke-miterlimit:10}"),
        React__default['default'].createElement("g", { id: "Plates" },
            React__default['default'].createElement("ellipse", { className: "st2", cx: 24, cy: 16, rx: 23, ry: 11 }),
            React__default['default'].createElement("path", { className: "st2", d: "M7 18c0-4.4 7.6-8 17-8s17 3.6 17 8M47 23c0 6.4-10.3 12-23 12S1 29.4 1 23" }),
            React__default['default'].createElement("path", { className: "st2", d: "M47 31c0 6.3-10.3 12-23 12S1 37.3 1 31" }))));
};
...
var Icon$1h = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 256 256" }, props),
        React__default['default'].createElement("image", { width: 256, height: 256, href: "/images/custom/logo-mobile.png" })));
};
...
var Logo$2 = function (_a) {
    ...
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 628 120" }, props),
        React__default['default'].createElement("image", { width: 628, height: 120, href: "/images/custom/logo-desktop.png" })));
};
var LogoWithTextIcon = React__default['default'].memo(Logo$2, function (prev, next) { return prev.isDark === next.isDark; });

var Icon$1e = function (props) {
    return (React__default['default'].createElement(MenuSvg, __assign({ viewBox: "0 0 48 48" }, props),
        React__default['default'].createElement("style", null, ".st1{fill:none;stroke-width:2;stroke-miterlimit:10}"),
        React__default['default'].createElement("g", { id: "Money" },
            React__default['default'].createElement("path", { className: "st1", d: "M1 15H41V39H1z" }),
            React__default['default'].createElement("path", { className: "st1", d: "M7 15L7 9 47 9 47 33 41 33" }),
            React__default['default'].createElement("circle", { className: "st1", cx: 21, cy: 27, r: 6 }))));
};
...
var Icon$Y = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 256 256" }, props),
        React__default['default'].createElement("image", { width: 256, height: 256, href: "/images/custom/main-token.png" })));
};
...
var Icon$x = function (props) {
    ...
    //   />
    // </Svg>
    React__default['default'].createElement(MenuSvg, __assign({ viewBox: "0 0 48 48" }, props),
...
var CakePrice = function (_a) {
    ...
    return cakePriceUsd ? (React__default['default'].createElement(PriceLink, { href: "https://dex.bungfi.com/swap?outputCurrency=0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c", target: "_blank" },
...
var MenuItems = function (_a) {
    ...
    return (React__default['default'].createElement(Flex, __assign({}, props), items.map(function (_a) {
        ...
        return (React__default['default'].createElement(DropdownMenu, { key: label + "#" + href + "#" + icon, items: menuItems, py: 1, activeItem: activeSubItem },
            React__default['default'].createElement(MenuItem, __assign({}, linkProps, { isActive: isActive, statusColor: statusColor }), label || React__default['default'].createElement(IconComponent, { iconName: icon, color: isActive ? "text" : "textSubtle" }))));
    })));
};
